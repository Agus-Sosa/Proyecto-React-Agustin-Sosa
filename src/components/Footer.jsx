    ...
    return (
        ...
        <footer className="footer items-center p-4 text-neutral-content">
                <div className="items-center grid-flow-col">
                    <a href="https://github.com/Agus-Sosa"><span className="icono-github text-black	" ><AiFillGithub/></span></a>
                    <p className="m-auto text-black	">Copyright © 2022 - Todos los derechos reservados</p>
                </div> 
